        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "VolunteerDonations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharityNeedId = table.Column<int>(type: "int", nullable: true),
                    VolunteerName = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolunteerDonations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VolunteerDonations_CharityNeeds_CharityNeedId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Receptionists", x => x.ApplicationUserId);
                    table.ForeignKey(
                        name: "FK_Receptionists_Users_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepressionScore = table.Column<int>(type: "int", nullable: false),
                    StressScore = table.Column<int>(type: "int", nullable: false),
                    SurveyDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentalHealthSurvies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MentalHealthSurvies_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "ApplicationUserId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_Receptionists_ConfirmedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelOutput = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TumorLocation = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diagnostics_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "9f8d4b9b-1e52-4dbf-a356-2c62b9db5b01", "11111111-1111-1111-1111-111111111111", "Admin", "ADMIN" },
                    { "a7e13e2a-63a7-4c5d-a5b9-5b49efb0123f", "22222222-2222-2222-2222-222222222222", "Doctor", "DOCTOR" },
                    { "b3f14a23-34a5-4bc0-912d-0f2f1d8d4a11", "33333333-3333-3333-3333-333333333333", "Receptionist", "RECEPTIONIST" },
                    { "c4f72d94-5632-4cb1-9c33-2a72e1c77788", "44444444-4444-4444-4444-444444444444", "Patient", "PATIENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diagnostics_MedicalRecordId",
                table: "Diagnostics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MentalHealthSurvies_PatientId",
                table: "MentalHealthSurvies",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerDonations_CharityNeedId",
                table: "VolunteerDonations",
